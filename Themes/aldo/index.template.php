...
$request = $smcFunc['db_query']('', '
	...
	WHERE filename LIKE {text:fileProjectName} and filename NOT LIKE {text:fileNot} and smf_messages.id_msg = smf_attachments.id_msg Order by ((karma_good - karma_bad)*((RAND()%0.3)+0.85)) DESC',
	array(
...
function template_body_below()
{
	global $context, $settings, $options, $scripturl, $txt, $modSettings;
        ...
        <div class="social">';
				...
				echo '
		                     <a href="', $settings['google+_url'] , '" class="icon-button google-plus"><i class="icon-google-plus"></i><span></span></a>';
